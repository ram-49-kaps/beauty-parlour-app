...
import { getImageUrl } from '../config'; // ✅ Import Helper
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 w-full md:w-auto no-scrollbar">
            {priceOptions.map((option) => (
              <button
                ...
                className={`whitespace-nowrap px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-300 border ${priceFilter === option.id
              ...
              return (
                ...
                >
                  <div className="relative h-72 overflow-hidden flex-shrink-0">
                    <img
                      src={getImageUrl(service.image_url) || 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800'}
                      alt={service.name}
