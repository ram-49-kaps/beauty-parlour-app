    ...
    <div className="min-h-screen bg-white text-gray-600 pt-20 p-6 md:p-12 font-sans selection:bg-gray-900/10">
      ...
      <div className="max-w-4xl mx-auto animate-fade-in">
        ...
        <div className="border-b border-gray-200 pb-8 mb-10">
          ...
          <h1 className="text-3xl md:text-4xl text-gray-900 font-light uppercase tracking-widest mb-4">Terms & Conditions</h1>
        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-12">
          <section>
            <h2 className="text-gray-900 text-sm font-bold uppercase tracking-widest mb-4 flex items-center gap-3">
              <span className="w-1.5 h-1.5 bg-gray-900 rounded-full"></span> 01. Appointments
            </h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-bold uppercase tracking-widest mb-4 flex items-center gap-3">
              <span className="w-1.5 h-1.5 bg-gray-900 rounded-full"></span> 02. Cancellations
            </h2>
            <p className="text-gray-500 text-sm leading-7 font-light">
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-bold uppercase tracking-widest mb-4 flex items-center gap-3">
              <span className="w-1.5 h-1.5 bg-gray-900 rounded-full"></span> 03. Payments
            </h2>
            <p className="text-gray-500 text-sm leading-7 font-light">
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-bold uppercase tracking-widest mb-4 flex items-center gap-3">
              <span className="w-1.5 h-1.5 bg-gray-900 rounded-full"></span> 04. Health & Safety
            </h2>
            <p className="text-gray-500 text-sm leading-7 font-light">
